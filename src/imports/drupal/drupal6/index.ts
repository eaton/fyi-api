...
interface Drupal6ImportOptions
  ...
  `
    ...
    if (this.options.nodeMultiValueFields) {
      ...
      for (const [field, columns] of Object.entries(
        this.options.nodeMultiValueFields
      )) {
